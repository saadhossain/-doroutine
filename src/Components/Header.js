        ...
        <div className='bg-gray-50 border bottom-1 border-gray-100'>
            <div className='w-11/12 lg:w-10/12 mx-auto py-2 flex justify-between items-center'>
                ...
                <div className='flex gap-2 items-center'>
                    <ul className={`lg:flex gap-2 font-semibold font-bigshoulder absolute lg:static text-primary ${expand ? 'top-14 right-0': 'top-[-200px] right-0'} bg-gray-50 w-full py-2 px-5 shadow-lg duration-500 ease-in-out` }>
                        <li>
