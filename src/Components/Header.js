...
const Header = () => {
    ...
    return (
        <div className={`border-b ${darkMode ? 'border-gray-300 bg-gray-100 ': 'border-primary bg-gray-900'}`}>
            <div className='w-11/12 lg:w-10/12 mx-auto py-2 flex justify-between items-center'>
                ...
                <div className='flex gap-2 items-center'>
                    <ul className={`lg:flex gap-5 font-semibold font-bigshoulder absolute lg:static text-primary ${expand ? 'top-14 right-0' : 'top-[-200px] right-0'} ${darkMode ? 'bg-gray-50' : 'bg-gray-900'} lg:bg-transparent w-full py-2 px-5 shadow-xl lg:shadow-none duration-500 ease-in-out`}>
                        <li>
